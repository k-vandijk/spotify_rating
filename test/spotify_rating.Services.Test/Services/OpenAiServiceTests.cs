...
//    {
//        // Arrange
//        var oldList = new List<UserTrack>
//        {
//            new UserTrack { Title = "Song A", Artist = "Artist 1" },
//            new UserTrack { Title = "Song B", Artist = "Artist 2" }
//        };

//        var newList = new List<UserTrack>
//        {
//            new UserTrack { Title = "Song A", Artist = "Artist 1" },
//            new UserTrack { Title = "Song C", Artist = "Artist 3" }
//        };
